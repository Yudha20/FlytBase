  ...
  return (
    <div className="flex flex-col items-start justify-center select-none w-full gap-1.5">
      ...
      <div className="flex items-center gap-3 animate-[fadeInUp_0.4s_ease-out_forwards]">
        ...
        <h1 className="text-[24px] font-semibold text-white tracking-tight leading-tight">
          Monitoring active
        </h1>
      </div>

      {/* Line 2: System Heartbeat */}
      <div className="pl-[22px] animate-[fadeInUp_0.4s_ease-out_0.12s_forwards] opacity-0 flex items-center gap-3 text-[12px] text-white/60 font-medium tracking-wide">
