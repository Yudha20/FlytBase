            ...
            <div className="flex-1 bg-surface border border-white/5 rounded-xl overflow-hidden flex flex-col shadow-neu-flat relative bg-gradient-card">
                ...
                <div className="flex-1 p-4 overflow-hidden bg-black/40 shadow-inner">
                    <div className={`grid h-full gap-4 ${
                        layout === 'focus' ? 'grid-cols-4 grid-rows-2' : 
                         ...
                         <div>
                             ...
                             <div className="flex items-center gap-2 mt-1 flex-wrap text-[13px] text-white/50">
                                 ...
                                 <button 
                                    ...
                                    className="hover:text-white transition-colors cursor-pointer flex items-center gap-1 group/id"
                                ...
                                {!showDronePresets ? (
                                    <div className="space-y-2">
                                        ...
                                        <button 
                                            ...
                                            className={`w-full p-3 rounded-lg flex items-center justify-between transition-all shadow-neu-flat hover:shadow-neu-hover ${
                                                isPerimeterLocked 
